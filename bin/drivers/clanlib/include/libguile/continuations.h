...
GUILE_API extern SCM scm_make_cont (SCM * answer);
GUILE_API extern SCM scm_call_continuation (SCM cont, SCM val);
GUILE_API extern void scm_init_continuations (void);
